...
public class SelectNoGroupStatementTest {
    ...
    public void setUp() throws FedException {
        Logger.getLogger();
        Logger.infoln("Start to test create select no group semantic validator.");
    ...
    public void tearDown() {
        ...
        Logger.infoln("Finished to test select no group statement semantic validator.");
    }

    @Test
    public void testTable1DoesNotExists() throws ParseException, FedException, Exception {
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2";
    ...
    public void testFQAttributeWithInvalidTable() {
        ...
        String selectFluglinie = "select FLUGLINIE3.Test from FLUGLINIE, FLUGLINIE2";
    ...
    public void testFQAttributeWithInvalidAttribute() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select FLUGLINIE2.Test from FLUGLINIE, FLUGLINIE2";
    ...
    public void testNonJoinOrNonJoinWithInvalidTable1() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE ((FLUGLINIE3.FLC > 'AB') OR (FLUGLINIE2.FLC > 'AB'))";
    ...
    public void testNonJoinOrNonJoinWithInvalidTable2() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE ((FLUGLINIE2.FLC > 'AB') OR (FLUGLINIE3.FLC > 'AB'))";
    ...
    public void testNonJoinOrNonJoinWithInvalidAttribute1() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE ((FLUGLINIE.Test > 'AB') OR (FLUGLINIE2.FLC > 'AB'))";
    ...
    public void testNonJoinOrNonJoinWithInvalidAttribute2() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE ((FLUGLINIE.FLC > 'AB') OR (FLUGLINIE2.Test > 'AB'))";
    ...
    public void testNonJoinOrNonJoinWithInvalidTypesVarChar() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE ((FLUGLINIE.FLC > 1) OR (FLUGLINIE2.FLC > 'AB'))";
    ...
    public void testJoinWithInvalidTypesInteger() {
        ...
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE ((FLUGLINIE.FLC > 'AB') OR (FLUGLINIE2.FLC > 'AB'))";
    ...
    public void testJoinWithInvalidTable1() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE3.FLC = FLUGLINIE2.FLC)";
    ...
    public void testJoinWithInvalidTable2() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE.FLC = FLUGLINIE3.FLC)";
    ...
    public void testJoinWithInvalidAttribute1() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE.Test <= FLUGLINIE2.FLC)";
    ...
    public void testJoinWithInvalidAttribute2() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE.FLC <= FLUGLINIE2.Test)";
    ...
    public void testJoinWithNonJoinNonJoinWithInvalidJoin() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE3.FLC = FLUGLINIE2.FLC) AND ((FLUGLINIE1.FLC > 'AB') OR (FLUGLINIE2.FLC <= 'AB'))";
    ...
    public void testJoinWithNonJoinNonJoinWithInvalidNonJoin1() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE.FLC = FLUGLINIE2.FLC) AND ((FLUGLINIE3.FLC > 'AB') OR (FLUGLINIE2.FLC <= 'AB'))";
    ...
    public void testJoinWithNonJoinNonJoinWithInvalidNonJoin2() {
        String createFluglinie = "create table FLUGLINIE ( FLC varchar(2), constraint FLUGLINIE_FLC primary key (FLC))";
        String createFluglinie2 = "create table FLUGLINIE2 ( FLC varchar(2), constraint FLUGLINIE2_FLC primary key (FLC))";
        String selectFluglinie = "select * from FLUGLINIE, FLUGLINIE2 WHERE (FLUGLINIE.FLC = FLUGLINIE2.FLC) AND ((FLUGLINIE.FLC > 'AB') OR (FLUGLINIE3.FLC <= 'AB'))";
