...
public class FedResultSetJoinHorizontal extends FedResultSetJoin {

    public FedResultSetJoinHorizontal() {
        super();
    }
    
    @Override
    public void createTestTables()throws FedException {
        executeUpdate("create table FLUGHAFEN ( FHC varchar(3), LAND varchar(3), STADT varchar(50), NAME varchar(50), constraint FLUGHAFEN_PS primary key (FHC) ) horizontal (FHC('E','K'))");
