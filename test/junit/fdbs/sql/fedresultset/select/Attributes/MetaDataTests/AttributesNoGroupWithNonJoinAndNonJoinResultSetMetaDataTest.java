...
public class AttributesNoGroupWithNonJoinAndNonJoinResultSetMetaDataTest extends AttributesNoGroupMetaDataTest {
    ...
    public void testMetaDataDefaultResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedAndNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testSelectMetaData(first, NoGroupWithNonJoinAndNonJoinDefaultResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
    ...
    public void testMetaDataVonDefaultResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedAndNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testFlugVonUnqieSelectMetaData(first, NoGroupWithNonJoinAndNonJoinDefaultResultSet.class,
    ...
    public void testMetaDataVerticalTwoDB1ResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedAndNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testSelectMetaData(first, NoGroupWithNonJoinAndNonJoinVerticalResultSet.class,
                        attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    ...
    public void testMetaDataVonVerticalTwoDB1ResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedAndNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testFlugVonUnqieSelectMetaData(first, NoGroupWithNonJoinAndNonJoinVerticalResultSet.class,
                        attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    ...
    public void testMetaDataHorizontalTwoDBPrimaryKeyResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedAndNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testSelectMetaData(first, NoGroupWithNonJoinAndNonJoinHorizontalResultSet.class,
                        attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
