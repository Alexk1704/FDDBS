...
public class AttributesNoGroupWithNonJoinResultSetMetaDataTest extends AttributesNoGroupMetaDataTest {
    ...
    public void testMetaDataDefaultResultSet() throws FedException {
        ...
        for (NonJoinInfo info : AllAttribtuesNoGroupNonJoinTest.getNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testSelectMetaData(first, NoGroupWithNonJoinDefaultResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
    ...
    public void testMetaDataVonDefaultResultSet() throws FedException {
        ...
        for (NonJoinInfo info : AllAttribtuesNoGroupNonJoinTest.getNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testFlugVonUnqieSelectMetaData(first, NoGroupWithNonJoinDefaultResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
    ...
    public void testMetaDataVerticalTwoDB1ResultSet() throws FedException {
        ...
        for (NonJoinInfo info : AllAttribtuesNoGroupNonJoinTest.getNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testSelectMetaData(first, NoGroupWithNonJoinVerticalResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
    ...
    public void testMetaDataVonVerticalTwoDB1ResultSet() throws FedException {
        ...
        for (NonJoinInfo info : AllAttribtuesNoGroupNonJoinTest.getNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testFlugVonUnqieSelectMetaData(first, NoGroupWithNonJoinVerticalResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
    ...
    public void testMetaDataHorizontalTwoDBPrimaryKeyResultSet() throws FedException {
        ...
        for (NonJoinInfo info : AllAttribtuesNoGroupNonJoinTest.getNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariations()) {
                testSelectMetaData(first, NoGroupWithNonJoinHorizontalResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
