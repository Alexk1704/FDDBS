...
public class AttributesNoGroupWithNonJoinOrNonJoinResultSetValueTest extends AttributesNoGroupValueTest {
    ...
    public void testDataDefaultResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedOrNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariationsWithFNRPK()) {
                testSelectData(first, NoGroupWithNonJoinOrNonJoinDefaultResultSet.class, attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    }
    ...
    public void testDataVonDefaultResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedOrNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariationsWithVONPK()) {
                testFlugVonUnqieSelectData(first, NoGroupWithNonJoinOrNonJoinDefaultResultSet.class,
    ...
    public void testDataVerticalTwoDB1ResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedOrNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariationsWithFNRPK()) {
                testSelectData(first, NoGroupWithNonJoinOrNonJoinVerticalResultSet.class,
                        attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    ...
    public void testDataVonVerticalTwoDB1ResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedOrNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariationsWithVONPK()) {
                testFlugVonUnqieSelectData(first, NoGroupWithNonJoinOrNonJoinVerticalResultSet.class,
                        attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
    ...
    public void testDataHorizontalTwoDBPrimaryKeyResultSet() throws FedException {
        ...
        for (NestedNonJoinInfos info : AllAttribtuesNoGroupNonJoinTest.getNestedOrNonJoinInfos()) {
            for (List<String> attributes : getAttributesVariationsWithFNRPK()) {
                testSelectData(first, NoGroupWithNonJoinOrNonJoinHorizontalResultSet.class,
                        attributes, AllAttribtuesNoGroupNonJoinTest.createWhereClause(info), info.getFilterFunction());
                first = false;
            }
        }
