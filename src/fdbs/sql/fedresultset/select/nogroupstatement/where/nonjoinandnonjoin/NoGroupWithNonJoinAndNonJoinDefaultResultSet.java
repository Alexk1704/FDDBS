...
public final class NoGroupWithNonJoinAndNonJoinDefaultResultSet extends FedResultSet {
    ...
    public NoGroupWithNonJoinAndNonJoinDefaultResultSet(FedConnection fedConnection, Statement statement) throws FedException {
    ...
    protected void resolveStatement() throws FedException {
        ...
        localResultSet = getLocalResultSet(conditionStatement, 1);
